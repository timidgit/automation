...
def generate_iso27001_nfrm_html():
    ...
    tips = {
        ...
        'ASSURE': {'de': 'Assurance-Aktivität', 'en': 'Assurance Activity', 'de_def': 'Eine unabhängige Überprüfung zur Verifizierung der Kontrollwirksamkeit.', 'en_def': 'An independent review to verify control effectiveness.', 'meta': 'WorkUnitKind'},
    ...
    diagram = r"""
graph TD
#     %% ISO 27001 - ISO/IEC 24744 Compliant
...
#     %% The core Risk-Goal relationship.
...
<body class="p-6 md:p-8">
    <div class="max-w-7xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-gray-200">
        <header class="mb-8 text-center border-b pb-6">
            <h1 class="text-4xl font-bold header-title">ISO 27001 Process View </h1>
